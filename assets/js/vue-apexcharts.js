(function (global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? (module.exports = factory(require("apexcharts/dist/apexcharts.min")))
    : typeof define === "function" && define.amd
    ? define(["apexcharts/dist/apexcharts.min"], factory)
    : (global.VueApexCharts = factory(global.ApexCharts));
})(this, function (ApexCharts) {
  "use strict";

  ApexCharts =
    ApexCharts && ApexCharts.hasOwnProperty("default")
      ? ApexCharts["default"]
      : ApexCharts;
  ...
  var ApexChartsComponent = {
    ...
    methods: {
      ...
      toggleDataPointSelection: function toggleDataPointSelection(
        seriesIndex,
        dataPointIndex
      ) {
