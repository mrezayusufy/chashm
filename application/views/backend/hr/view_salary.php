                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <div class="btn-group" id="status" >
                                <button class="btn btn-outline-dark" disabled :class="{'active btn-primary': (chooseSalary.status == 'paid')}" @click="changeStatus('paid')">  <?= get_phrase('paid'); ?></button>
                                <button class="btn btn-outline-dark" disabled :class="{'active btn-danger': (chooseSalary.status == 'unpaid')}" @click="changeStatus('unpaid')">  <?= get_phrase('unpaid'); ?></button>
                            </div>
                        </div>
                    </div>
